...
cur.execute(
    """
    CREATE TABLE users (id SERIAL PRIMARY KEY, username VARCHAR(80) UNIQUE NOT NULL, password VARCHAR(80) NOT NULL, email VARCHAR(100) UNIQUE NOT NULL, points INT NOT NULL)
    """
)
cur.close()
conn.commit()